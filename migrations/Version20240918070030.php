 ...
 */
final class Version20240918070030 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE question ADD guid BINARY(16) NOT NULL COMMENT \'(DC2Type:uuid)\'');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE question DROP guid');
